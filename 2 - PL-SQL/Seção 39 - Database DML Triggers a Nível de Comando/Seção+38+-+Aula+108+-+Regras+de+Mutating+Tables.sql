...
BEGIN
  ...
  THEN  
      RAISE_APPLICATION_ERROR(-20001, 'Salario nÃ£o pode ser superior ao maior salario + 20%');
  END IF;
END;
...
BEGIN
  ...
  THEN  
      RAISE_APPLICATION_ERROR(-20001, 'Novo salario não pode ser superior ao maior salário + 20%');
  END IF;
END;
